...
public class ListadoTarjetasTest {
    ...
    public void obtenerDatosClienteOkVisaCR() {
        XmlObject result = ListadoTarjetas.obtenerListadoTarjetas("CR", "5 0225 0153", "jdbc/SUNTSTCR", "jdbc/ORIONREPOSV", "http://soauat.siman.com:7003/v1/orion", "usuario", "600831, 600831, 600831");
        //Status
        assertEquals("00", ((SimpleValue) result.selectPath( "declare namespace ns='" + NS + "' " + ".//ns:statusCode")[0]).getStringValue());
        assertEquals("SUCCESS", ((SimpleValue) result.selectPath( "declare namespace ns='" + NS + "' " + ".//ns:status")[0]).getStringValue());
    }
